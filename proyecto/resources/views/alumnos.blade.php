    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Alumnos</h1>
            </div>
        </header>
        <main>
                    ...
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-gray-900">MARIANA MARTÍNEZ</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">2030348@upv.edu.mx</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900">INGENIERÍA EN TECNOLOGÍAS DE LA INFORMACIÓN</p>
                        </div>
                    </li>
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-gray-900">SEBASTIAN LUJANO</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">2030390@upv.edu.mx</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900">LICENCIATURA EN COMERCIO INTERNACIONAL Y ADUANAS</p>
                        </div>
                    </li>
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-gray-900">RAMIRO TORRES</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">2030246@upv.edu.mx</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900">INGENIERÍA MECATRÓNICA</p>
                        </div>
                    </li>
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-gray-900">ALEJANDRA HERNANDEZ</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">2030268@upv.edu.mx</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900">LICENCIATURA EN ADMINISTRACIÓN Y GESTIÓN EMPRESARIAL</p>
                        </div>
                    </li>
                    <li class="flex justify-between gap-x-6 py-5">
                        <div class="flex gap-x-4">
                            ...
                            <div class="min-w-0 flex-auto">
                                <p class="text-sm font-semibold leading-6 text-gray-900">ALEXA ALVARADO</p>
                                <p class="mt-1 truncate text-xs leading-5 text-gray-500">2030369@upv.edu.mx</p>
                            </div>
                        </div>
                        <div class="hidden sm:flex sm:flex-col sm:items-end">
                            <p class="text-sm leading-6 text-gray-900">INGENIERÍA EN TECNOLOGÍAS DE LA INFORMACIÓN</p>
