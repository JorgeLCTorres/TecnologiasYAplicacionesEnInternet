    ...
    <div class="min-h-full">
        ...
        <header class="bg-white shadow">
            <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                <h1 class="text-3xl font-bold tracking-tight text-gray-900">Página Principal</h1>
            </div>
        </header>
        <main>
            <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
                ...
                <section class="relative isolate overflow-hidden bg-white px-6 py-24 sm:py-32 lg:px-8">
                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-4xl">
                        <img class="mx-auto h-12" src="{!! asset('img/logo.png') !!}" alt="">
                        <figure class="mt-10">
                            <blockquote class="text-center text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
                                <br> <p>¡Bienvenidos a mi sitio web! Aquí encontrarás una experiencia única y emocionante donde podrás descubrir un mundo totalmente nuevo.</p> <br>
                                <br> <p>Me complace tenerte aquí y espero que disfrutes de tu experiencia en mi sitio web. ¡Prepárate para comenzar un viaje fascinante lleno de aprendizaje, inspiración y nuevas posibilidades!</p> <br>
                            </blockquote>
